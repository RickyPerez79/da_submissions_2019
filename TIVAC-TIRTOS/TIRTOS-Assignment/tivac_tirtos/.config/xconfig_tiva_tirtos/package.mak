...
override PKGDIR = xconfig_tiva_tirtos
...
package/%.xdc.inc package/%_xconfig_tiva_tirtos.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_tiva_tirtos" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: tiva_tirtos.pem4f

-include package/cfg/tiva_tirtos_pem4f.mak
-include package/cfg/tiva_tirtos_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/tiva_tirtos_pem4f.dep
endif
tiva_tirtos.pem4f: package/cfg/tiva_tirtos_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
tiva_tirtos.pem4f package/cfg/tiva_tirtos_pem4f.c: .libraries,em4f
endif

package/cfg/tiva_tirtos_pem4f.c package/cfg/tiva_tirtos_pem4f.h package/cfg/tiva_tirtos_pem4f.xdl: override _PROG_NAME := tiva_tirtos.xem4f
package/cfg/tiva_tirtos_pem4f.c: package/cfg/tiva_tirtos_pem4f.cfg
package/cfg/tiva_tirtos_pem4f.xdc.inc: package/cfg/tiva_tirtos_pem4f.xdl
package/cfg/tiva_tirtos_pem4f.xdl package/cfg/tiva_tirtos_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/tiva_tirtos_pem4f.cfg
	-$(RM) package/cfg/tiva_tirtos_pem4f.dep
	-$(RM) package/cfg/tiva_tirtos_pem4f.c
	-$(RM) package/cfg/tiva_tirtos_pem4f.xdc.inc

clean,em4f::
	-$(RM) tiva_tirtos.pem4f
.executables,em4f .executables: tiva_tirtos.xem4f

tiva_tirtos.xem4f: |tiva_tirtos.pem4f

-include package/cfg/tiva_tirtos.xem4f.mak
tiva_tirtos.xem4f: package/cfg/tiva_tirtos_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/tiva_tirtos_pem4f.oem4f   package/cfg/tiva_tirtos_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
tiva_tirtos.xem4f: export C_DIR=
tiva_tirtos.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
tiva_tirtos.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

tiva_tirtos.test test,em4f test: tiva_tirtos.xem4f.test

tiva_tirtos.xem4f.test:: tiva_tirtos.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 tiva_tirtos.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.tiva_tirtos.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,tiva_tirtos.xem4f,*)


clean:: clean,em4f

clean,em4f::
	-$(RM) tiva_tirtos.xem4f
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
tiva_tirtos_pem4f.oem4f,copy : package/cfg/tiva_tirtos_pem4f.oem4f
tiva_tirtos_pem4f.sem4f,copy : package/cfg/tiva_tirtos_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_tiva_tirtos
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_tiva_tirtos.tar.dep
endif
package/rel/xconfig_tiva_tirtos/xconfig_tiva_tirtos/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_tiva_tirtos/xconfig_tiva_tirtos/package/package.rel.xml: package/build.cfg
package/rel/xconfig_tiva_tirtos/xconfig_tiva_tirtos/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_tiva_tirtos/xconfig_tiva_tirtos/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_tiva_tirtos.tar: package/rel/xconfig_tiva_tirtos.xdc.inc package/rel/xconfig_tiva_tirtos/xconfig_tiva_tirtos/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_tiva_tirtos.xdc.inc,package/rel/xconfig_tiva_tirtos.tar.dep)


release release,xconfig_tiva_tirtos: all xconfig_tiva_tirtos.tar
clean:: .clean
	-$(RM) xconfig_tiva_tirtos.tar
	-$(RM) package/rel/xconfig_tiva_tirtos.xdc.inc
	-$(RM) package/rel/xconfig_tiva_tirtos.tar.dep
