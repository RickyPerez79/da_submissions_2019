...
int main(void)
{
    ...
    {
        //if
        if (ROM_GPIOPinRead(GPIO_PORTF_BASE,GPIO_PIN_4)==0x00)// || ROM_GPIOPinRead(GPIO_PORTF_BASE,GPIO_PIN_0)==0x00) // if sw1 is pressed, will go 0 to 180 degrees
        {

            while(ui8Adjust){
               ROM_SysCtlDelay(100000*50);
              //  ROM_SysCtlDelay(100000*10);
                while(ui8Adjust < 115)
                {
                    ROM_PWMPulseWidthSet(PWM1_BASE, PWM_OUT_0, ui8Adjust * ui32Load / 1000);
                    ui8Adjust++;
         ...
         */
        //    if(ROM_GPIOPinRead(GPIO_PORTF_BASE,GPIO_PIN_0)==0x00) // if sw2 is pressed, will go 0 to 180 degrees
        //  {
        //    while(ui8Adjust < 115)
        //  {
        //    ROM_PWMPulseWidthSet(PWM1_BASE, PWM_OUT_0, ui8Adjust * ui32Load / 1000);
